...
class Flat(models.Model):
    ...
    normalized_owner_phonenumber = PhoneNumberField("Нормализованный номер владельца", blank=True)
    ...
    liked_by = models.ManyToManyField("Person", related_name="liked_flats", blank=True)
